...
# --- Configuration ---
art_file="$HOME/.config/hypr/scripts/nowplaying/album_art.jpg"
fallback_art_file="$HOME/.config/hypr/scripts/nowplaying/fallback_album_art.jpg"
cache_file="$HOME/.config/hypr/scripts/nowplaying/song_title.cache"
